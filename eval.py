"""
Copied from main.py in the DPM-Solver repo
"""
import argparse
import traceback
import shutil
...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--stride", type=int, default=1, help="stride for stepsize"
    )
    parser.add_argument(
        "--dpm_solver_method",
        type=str,
        default="singlestep",
        help="method of dpm_solver ('adaptive' or 'singlestep' or 'multistep' or 'singlestep_fixed' or 'speculative'",
    )
    parser.add_argument(
        "--dpm_solver_type",
        type=str,
